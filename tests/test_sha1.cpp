...
TEST_F(TestSha1, empty)
{
    ...
    EXPECT_EQ("da39a3ee5e6b4b0d3255bfef95601890afd80709", hasher_->get_digest());
}
...
TEST_F(TestSha1, simple_string1)
{
    ...
    EXPECT_EQ("2fd4e1c67a2d28fced849ee1bb76e7391b93eb12", hasher_->get_digest());
}
...
TEST_F(TestSha1, simple_string2)
{
    ...
    hasher_->hash_data(std::vector<uint8_t>(str.begin(), str.end()));
    EXPECT_EQ("de9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3", hasher_->get_digest());
}
